...
const LogoLink = tw.a``;
const LogoImage = tw.img`h-20 mx-auto rounded-full`;
...
const SubmitButton = styled.button  ${tw`mt-5 tracking-wide font-semibold bg-primary-`
500 text-gray-100 w-full py-4 rounded-lg hover:bg-primary-900 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none`}
  .icon {
    ${tw`w-6 h-6 -ml-2`}
  }
