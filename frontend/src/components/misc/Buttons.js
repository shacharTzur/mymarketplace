...
export const DeleteButton = tw.button`px-3 py-3 font-bold rounded-full hocus:text-gray-200 focus:shadow-outline focus:outline-none transition duration-300`;
